...
<form action="{{route('product_details')}}" method='Post'  enctype="multipart/form-data"><!--route:name listed for route-->
@csrf         <!--for security-->
  ...
  <a class='btn btn-secondary' href ="{{route('product_details')}}">Back</a>
</form>
</div>
  </div>
