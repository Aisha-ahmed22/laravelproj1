...
@section('content')
    ...
    <table id="cart" class="table table-hover table-condensed">
        ...
        <tr>
            <td data-th="Product">
                <div class="row">
                    <div class=" col-lg-5 col-sm-3 hidden-xs"><img src="{{ asset('Uploads/'.$details['image'])  }} " alt="..." class="img-responsive" styl="width: 400"/></div>
            ...
            <td>
                <div class="col-lg-8">
                    <div class="card text-white" style="background-color: orange" >
                        ...
                        <div class="card-body">
                        <h3 class="card-title">Your Cart <hr></h3>
                        <div class="card-text"> 
                            <p>Total Amount Is {{$total}}</p>
                            
                            <a href="{{route('cart.checkout' , $total)}}" class="text-white">checkout</a>
                        </div>
